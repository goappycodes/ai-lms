...
const en = {
  ...
  "login.demo.student1": "Student 1",
  "login.demo.student2": "Student 2",
  "login.demo.student3": "Student 3",
  "login.demo.sub.superadmin": "All content",
  "login.demo.sub.school": "Its classes",
  "login.demo.sub.teacher": "Own classes",
  "login.demo.sub.student1": "Explorer",
  "login.demo.sub.student2": "Builder",
  "login.demo.sub.student3": "Achiever",
